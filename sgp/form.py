...
from wtforms.validators import ReadOnly,DataRequired,Optional
...
class FichaPedido(FlaskForm):
    ...
    name_client = StringField(label="Insira o nome do cliente",validators=[DataRequired()])
    data_entrada = DateField(label="Data de Entrada",validators=[DataRequired("Insira uma data de entrada")])
    ...
    observacao = StringField("",validators=[Optional()])
